...
* [`src/cljs/flexiana/`](src/cljs/flexiana/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/flexiana/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `flexiana` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/flexiana/config.cljs) defaults to `true` in
...
```clj
(ns flexiana.example
  (:require [flexiana.config :as config])
